...
describe User do
  ...
  describe "email address with mixed case" do
    ...
    it "should be saved as all lower-case" do
      ...
      @user.save
      #ve expect(@user.reload.email).to eq mixed_case_email.downcase
    end
  end
  ...
  describe "micropost associations" do
    ...
    let!(:older_micropost) do
      FactoryGirl.create(:micropost, user: @user, group_id: 1 ,created_at: 1.day.ago)
    end
    let!(:newer_micropost) do
      FactoryGirl.create(:micropost, user: @user, group_id: 1 ,created_at: 1.hour.ago)
    end
